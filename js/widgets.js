 ...
 *
 */
 (function(b){b.widget("ui.scrollbar",{options:{width:"auto"},_create:function(){this.element.addClass("ui-scrollbar-container");this._build();this._bind();this._resize()},_build:function(){this.elements={contentContainer:b("<div />").addClass("ui-scrollbar-content-container"),bars:{}};this.elements.bars.vertical={baseContainer:b("<div />").addClass("ui-widget-content ui-corner-all ui-scrollbar-base-container"),base:b("<div />").addClass("ui-scrollbar-base"),face:b("<a />").attr("href","#").addClass("ui-state-default ui-widget-content ui-corner-all ui-scrollbar-face"), arrowUpContainer:b("<div />").addClass("ui-state-default ui-corner-all ui-scrollbar-arrow-up"),arrowUp:b("<div />").addClass("ui-icon ui-icon-triangle-1-n"),arrowDownContainer:b("<div />").addClass("ui-state-default ui-corner-all ui-scrollbar-arrow-down"),arrowDown:b("<div />").addClass("ui-icon ui-icon-triangle-1-s")};this.elements.bars.vertical.base.appendTo(this.elements.bars.vertical.baseContainer);this.elements.bars.vertical.face.appendTo(this.elements.bars.vertical.base);this.elements.bars.vertical.arrowUp.appendTo(this.elements.bars.vertical.arrowUpContainer); this.elements.bars.vertical.arrowDown.appendTo(this.elements.bars.vertical.arrowDownContainer);this.elements.contentContainer.append(this.element.contents()).prependTo(this.element).after(this.elements.bars.vertical.baseContainer).after(this.elements.bars.vertical.arrowUpContainer).after(this.elements.bars.vertical.arrowDownContainer)},_resize:function(){var d=Math.round(this.element.height()/this.element[0].scrollHeight*100);this._data={vertical:{elementHeight:this.element.height(),contentContainerHeight:this.elements.contentContainer.height(), baseContainerHeight:this.element.height()-4,baseHeight:this.element.height()-40,faceHeight:(this.element.height()-40)/100*d}};this.elements.bars.vertical.baseContainer.height(this._data.vertical.baseContainerHeight);this.elements.bars.vertical.base.height(this._data.vertical.baseHeight);this.elements.bars.vertical.face.height(this._data.vertical.faceHeight)},_bind:function(){function d(c){if(c.type=="mousedown"&&c.which<=1)if(c.target===a.elements.bars.vertical.arrowDown[0])a._scrollDown(c);else c.target== a.elements.bars.vertical.arrowUp[0]&&a._scrollUp(c);b(this).toggleClass("ui-state-hover ui-scrollbar-state-hover")}var a=this;this.elements.bars.vertical.arrowUpContainer.bind("mouseenter mouseleave mousedown mouseup",d);this.elements.bars.vertical.arrowDownContainer.bind("mouseenter mouseleave mousedown mouseup",d);this.elements.bars.vertical.face.bind("mouseenter mouseleave",function(){b(this).toggleClass("ui-state-hover")}).bind("focus blur",function(){b(this).toggleClass("ui-state-active")}).click(function(){return false}).draggable({axis:"y", containment:"parent"});this.element.bind("drag",function(c,e){a._scroll(c,e.position.top,e)});b.fn.mousewheel&&this.element.bind("mousewheel",function(c,e){e>0?a._scrollUp(c,4):a._scrollDown(c,4)})},_scrollUp:function(d,a){a=a||2;a=parseInt(this.elements.bars.vertical.face.css("top").replace(/px$/,""))-a;if(a>=0){this.elements.bars.vertical.face.css({top:a});this._scroll(d,a)}},_scrollDown:function(d,a){a=a||2;a=parseInt(this.elements.bars.vertical.face.css("top").replace(/px$/,""))+a;if(a<=this._data.vertical.baseHeight- this._data.vertical.faceHeight){this.elements.bars.vertical.face.css({top:a});this._scroll(d,a)}},_scroll:function(d,a,c){var e=this._data.vertical;this.elements.contentContainer.css({marginTop:-Math.round((e.contentContainerHeight-e.elementHeight)/100*a/(e.baseHeight-e.faceHeight)*100)+"px"});this._trigger("scroll",d,c)},destroy:function(){this.element.removeClass("ui-scrollbar-container");this.element.append(this.elements.contentContainer.contents());b.each(this.elements.bars.vertical,function(){b(this).remove()}); b.Widget.prototype.destroy.apply(this,arguments)}})})(jQuery);
